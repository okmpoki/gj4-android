...
public abstract class CameraBaseView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            synchronized (this) {
                ...
                if(frameNumber*10 % 300 == 0 && currentGreyscaleLevel > 0){
                    this.currentGreyscaleLevel -= 5;
            	}
